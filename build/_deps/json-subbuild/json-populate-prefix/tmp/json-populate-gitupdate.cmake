...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/lazlor/Documents/EPITECH-tech2/B-OOP-400/B-OOP-400-TLS-4-1-raytracer-guillaume1.blondel/build/_deps/json-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/lazlor/Documents/EPITECH-tech2/B-OOP-400/B-OOP-400-TLS-4-1-raytracer-guillaume1.blondel/build/_deps/json-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
